class AssetsManager {
  ...
  static const String commandeIcon = "$assetsIconsPath/commandFB.png";
  static const String commandeIcon2 = "$assetsIconsPath/Commande.png";
  static const String commandeIcon3 = "$assetsIconsPath/shopping.png";
  static const String livraisonIcon = "$assetsIconsPath/livraisonFB.png";
...
// general images
  ...
  // Resto
  static String resto1Image = "$restoImagesPath/resto_1.jpg";
  static String resto2Image = "$restoImagesPath/resto_2.jpg";
